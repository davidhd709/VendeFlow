...
const ACTION_LABELS: Record<string, string> = {
  ...
  'template.created':             'Plantilla de mensaje creada',
  'template.updated':             'Plantilla de mensaje actualizada',
  ...
  'website_config.updated':       'Configuración del sitio actualizada',
};
...
@Component({
  ...
  template: `
    <div class="sf-page">
      <app-page-header
        ...
        subtitle="Historial de acciones críticas realizadas en tu empresa."
      />

      <app-section-card
        title="Eventos"
        description="Todas las acciones importantes quedan registradas con actor y fecha."
      >
        ...
        @if (loading()) {
          ...
          <app-empty-state
            ...
            description="Los filtros seleccionados no arrojan resultados."
          />
        } @else {
          ...
          >
            ...
            <ng-template pTemplate="body" let-log>
              <tr>
                <td class="text-xs text-muted mono">{{ log.createdAt | date:'dd/MM/yy HH:mm' }}</td>
                <td>
  ...
  styles: [`
    ...
    .filters-bar .grow { flex: 2; min-width: 180px; }
